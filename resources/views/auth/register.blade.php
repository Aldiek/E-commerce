							...
							<div class="register-form form-item ">
                                ...
                                <form class="form-stl" method="POST" action="{{ route('register') }}">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <x-jet-input id="name" class="block mt-1 w-full" type="text" placeholder="Last name*" name="name" :value="old('name')" required autofocus autocomplete="name" />
                                    </fieldset>

                                    <fieldset class="wrap-input">

                                        <x-jet-label for="email" value="{{ __('Email') }}" />
                                        <x-jet-input id="email" class="block mt-1 w-full" placeholder="Email address" type="email" name="email" :value="old('email')" required />
                                    </fieldset>
