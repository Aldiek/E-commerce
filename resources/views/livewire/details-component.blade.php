            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-price"><ins> <span class="product-price">${{$product->sale_price}}</span></ins> <del><span class="product-price regprice">${{$product->regular_price}}</span> </del> </div>
                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{route('product.details',['slug'=>$popular_product->slug])}}" title="{{$popular_product->name}}">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$popular_product->image}}" alt="{{$popular_product->name}}">
                                            </figure>
                                        </a>
                                    </div>
