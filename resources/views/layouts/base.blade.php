...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+963) 936 947 625</a>
								</li>
							</ul>
						</div>
							...
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<ul class="submenu lang" >
										<li class="menu-item" ><a title="syria" href="#"><span class="img label-before"><img src="{{asset('assets/images/lang-sy.png')}}" width="20" height="15" alt="lang-hun"></span>Syria</a></li>
									</ul>
								</li>
								<li class="menu-item menu-item-has-children parent" >
									...
									<ul class="submenu curency" >
										<li class="menu-item" >
											<a title="Pound (GBP)" href="#">Pound (SY)</a>
										</li>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-icon right-section">
							@livewire('wishlistcount-component')
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<!-- <li class="menu-item">
									<a href="/doctors" class="link-term mercado-item-title">Doctors</a>
								</li> -->
								<li class="menu-item">
    ...
    <script src="https://cdn.tiny.cloud/1/17o4t2ulthf1wl4skdf86q9wsoscvkcc0s8p1tddslmnipky/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
    @stack('scripts')
</body>
</html>
